...
module Chatwoot
  class Application < Rails::Application
    ...
    # staydesk: custom/ overlay (custom/config/boot.rb, docs/staydesk/core-touches.md)
    require_relative '../custom/config/boot' if Rails.root.join('custom').exist? # staydesk
    StaydeskBoot.configure(config) if defined?(StaydeskBoot) # staydesk
