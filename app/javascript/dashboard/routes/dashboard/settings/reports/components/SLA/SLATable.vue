...
<template>
  <div>
    <div
      class="min-w-full outline-1 outline outline-n-container rounded bg-n-solid-2 p-6"
    >
      <div
        class="grid content-center h-12 grid-cols-12 gap-4 px-6 py-0 bg-n-slate-2 rounded"
      >
        <TableHeaderCell
          :span="6"
