    ...
    <div class="flex flex-col gap-3">
      ...
      <div v-else class="flex flex-col divide-y divide-n-weak">
        ...
        >
          <button
            type="button"
            class="flex items-center flex-1 min-w-0 !p-0 gap-3 text-start rounded transition-colors text-n-slate-12 hover:text-n-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-n-brand focus-visible:ring-offset-2 focus-visible:ring-offset-n-background"
