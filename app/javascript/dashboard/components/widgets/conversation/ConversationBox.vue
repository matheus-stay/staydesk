...
<template>
  <div
    class="conversation-details-wrap relative flex min-w-0 w-full flex-col overflow-hidden bg-n-surface-1"
    :class="{
  ...
  >
    ...
    <div
      v-show="!activeIndex"
      class="m-0 flex h-full min-h-0 bg-n-slate-2/70 dark:bg-n-background"
    >
      <MessagesView
        v-if="currentChat.id"
        :inbox-id="inboxId"
