...
<template>
  <div
    class="conversations-list-wrap relative flex flex-shrink-0 flex-col overflow-hidden border-n-weak bg-n-surface-1 md:border-e"
    :class="[
      { hidden: !showConversationList },
      isOnExpandedLayout ? 'basis-full' : 'w-[19.375rem]',
    ]"
  >
    <slot />
    <ChatListHeader
