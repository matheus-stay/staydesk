...
Api::V1::Accounts::CustomAttributeDefinitionsController.prepend_mod_with('Api::V1::Accounts::CustomAttributeDefinitionsController') # staydesk:hook campo obrigatório
